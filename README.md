...
- Tạo nhanh sản phẩm từ cả thư mục ảnh: suy ra tên hoa từ tên file, cho sửa tên và giá ngay trong bảng nhập, đọc giá gốc trong tên file hoặc nhập thủ công, gom tối đa bốn ảnh mỗi sản phẩm, chọn danh mục và xuất ZIP đúng mẫu GrabMerchant.
