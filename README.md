...
- Chức năng **Tạo sản phẩm từ bảng giá**: tạo dự thảo từ danh sách nhà cung cấp, tính giá bán theo hệ số, gắn ảnh được phép sử dụng và điền vào mẫu ZIP chính thức.
- Chức năng độc lập **Tạo sản phẩm từ thư mục ảnh**: suy ra tên hoa từ tên file, cho sửa tên và giá ngay trong bảng nhập, đọc giá gốc trong tên file hoặc nhập thủ công, gom tối đa bốn ảnh mỗi sản phẩm, chọn danh mục và xuất ZIP đúng mẫu GrabMerchant.
...
- Tên có thể lấy từ file ảnh hoặc tự sinh theo dạng **Danh mục – hậu tố tự nhiên**; ví dụ `Hoa chia buồn – Thành kính phân ưu`. Tên vẫn được phép sửa trước khi nạp.
- Giá có ba chế độ: đọc số trong tên file, nhập thủ công từng dòng, hoặc tự chọn giá bán ổn định trong khoảng nhỏ nhất–lớn nhất do người dùng nhập. Giá gốc được suy ra theo hệ số giá bán và vẫn có thể rà soát lại.
